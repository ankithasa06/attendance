...
function mapRecord(
  ...
  return {
    ...
    travelStartTime: r.travelStartTime?.toISOString() ?? null,
    returnTravelStartTime: r.returnTravelStartTime?.toISOString() ?? null,
    returnTravelEndTime: r.returnTravelEndTime?.toISOString() ?? null,
    status: r.status,
